      ...
      function (a, b, c) {
        ...
        (function () {
          ...
          (c = window.device),
            ...
            (g = function () {
              a.landscape()
                ? (j('portrait'), d('landscape'))
                : (j('landscape'), d('portrait'));
            }),
            ...
            window.addEventListener
              ? window.addEventListener(i, g, !1)
              : window.attachEvent
                ? window.attachEvent(i, g)
                : (window[i] = g),
            g(),
            ...
            e['default'](function () {
              jQuery.extend(jQuery.validator.messages, {
                ...
                jQuery.validator.addMethod(
                  ...
                  function (a, b) {
                    return (
                      this.optional(b) || /^[\d\+][\d\(\)\ -]{3,18}\d$/.test(a)
                    );
                  },
                ...
                e['default']('.js-form-validate').validate({
                  ...
                  errorPlacement: function (a, b) {
                    b.after(a),
                      a
                        .addClass('form__error-wrapper')
                        .append('<span class="form__error-hide"></span>');
                    var c = a.outerWidth(),
                      d = a.offset().left,
                ...
                e['default']('.form').on('click', function (a) {
                  ...
                  if (
                    (d.length && c.closest('.form__error-wrapper').hide(),
                      f.length)
                  ) {
                    var j,
                      k,
                      ...
                      i = this.elements;
                    for (b.trigger('reset'), j = 0, k = i.length; k > j; j++)
                      e['default'](i[j]).removeClass('valid invalid');
                    g.each(function () {
                      e['default'](this).removeClass(
                        'form__label_valid form__label_invalid'
                      );
                    }),
                      h.each(function () {
                        e['default'](this).hide();
                ...
                e['default']('.gallery').on('mouseover click', function (a) {
                  ...
                  if (d.length) {
                    ...
                    'mouseover' === a.type
                      ...
                      : 'click' === a.type &&
                      (c.hasClass('gallery__item_active') ||
                        (d
                          .addClass('gallery__thumbnails-item_active')
                          .siblings()
                          .removeClass('gallery__thumbnails-item_active'),
                          i.attr('src', g),
                          d.off('mouseout')));
                  }
                });
      ...
      function (a, b, c) {
        ...
        !(function () {
          f['default']('.input-number__counter-spin').on('click', function (a) {
            ...
            b.hasClass('input-number__counter-spin_less') && e > h
              ? d.val(e - g)
              : b.hasClass('input-number__counter-spin_more') && d.val(e + g);
          });
        })(f['default']);
      },
      { jquery: 13 },
            ...
            var g = a(window).width(),
              ...
              j = function () {
                (e.settings = a.extend({}, c, d)),
                  ...
                  (e.carousel =
                    e.settings.minSlides > 1 || e.settings.maxSlides > 1),
              ...
              q = function () {
                ...
                if (
                  ...
                  if (e.viewport.width() < e.minThreshold)
                    ...
                    a = Math.floor(
                      (e.viewport.width() + e.settings.slideMargin) / b
                    );
                  }
                else
                ...
                if (
                  ...
                  if ('horizontal' == e.settings.mode) {
                    var a = e.children.last(),
                      b = a.position();
                    u(
                      -(b.left - (e.viewport.width() - a.outerWidth())),
                      'reset',
                      0
                    );
                  ...
                  'horizontal' == e.settings.mode
                    ...
                    !e.settings.infiniteLoop &&
                      ...
                      : Math.abs(d) >= e.settings.swipeThreshold
                        ? (0 > d ? f.goToNextSlide() : f.goToPrevSlide(),
                          f.stopAuto())
                        : u(c, 'reset', 200);
                }
        ...
        f['default'](function () {
          f['default']('.tabs').on('click', function (a) {
            ...
            if (d.length) {
              ...
              d.hasClass('tabs__nav-item_active') ||
                (d
            ...
            e['default'](function () {
              ...
              e['default']('.js-block-show').on('click', function (a) {
                ...
                a.preventDefault(),
                  b.data('text', c),
                  b.text(d),
                  e['default']('[data-block=' + f + ']').toggleClass(
                    'block-show'
                  );
              }),
                ...
                e['default']('.header__menu').on('click', function (a) {
                  if (
                    e['default']('html').hasClass('tablet') ||
                    e['default']('html').hasClass('mobile')
                  ) {
                    var c = (e['default'](this), e['default'](a.target)),
                      d = c.closest('.menu__item');
                    d.length &&
                      d.has('.dropdown-menu') &&
                      (a.preventDefault(), d.trigger('hover'));
                  }
                });
            });
        }.call(
        ...
        !(function (a, b, c, d, e) {
          ...
          var f = 0,
            g = (function () {
              var e,
                ...
                c = /msie\s\d+/i;
              return b.search(c) > 0 &&
                ((e = c.exec(b).toString()), (e = e.split(' ')[1]), 9 > e)
          ...
          var h =
            ...
            l = function (d, e, f) {
              ...
              h &&
                ((h = h.split(
                  j.input_values_separator || e.input_values_separator || ';'
                )),
                  h[0] && h[0] == +h[0] && (h[0] = +h[0]),
                  h[1] && h[1] == +h[1] && (h[1] = +h[1]),
          ...
          (l.prototype = {
            ...
            setTopHandler: function () {
              ...
              c > a && d === b
                ...
                : b > d && this.$cache.s_to.addClass('type_last');
            },
            ...
            pointerUp: function (b) {
              this.current_plugin === this.plugin_count &&
                ...
                ((this.is_active = !1),
                  ...
                  (a.contains(this.$cache.cont[0], b.target) || this.dragging) &&
            ...
            pointerDown: function (b, c) {
              ...
              var d =
                c.pageX ||
                (c.originalEvent.touches && c.originalEvent.touches[0].pageX);
              2 !== c.button &&
                ...
                ('click' === this.target &&
                  ...
                  case 'both':
                    ...
                    (b = this.toFixed(b + 0.1 * this.coords.p_handle)),
                      (this.coords.p_from_real =
                        this.convertToRealPercent(b) - this.coords.p_gap_left),
                      (this.coords.p_from_real = this.calcWithStep(
                        this.coords.p_from_real
                      )),
                      (this.coords.p_from_real = this.checkDiapason(
                      ...
                      (this.coords.p_to_real =
                        this.convertToRealPercent(b) + this.coords.p_gap_right),
                      (this.coords.p_to_real = this.calcWithStep(
                        this.coords.p_to_real
                      )),
                      (this.coords.p_to_real = this.checkDiapason(
            ...
            calcPointerPercent: function () {
              return this.coords.w_rs
                ? (this.coords.x_pointer < 0 || isNaN(this.coords.x_pointer)
                  ...
                  (this.coords.x_pointer = this.coords.w_rs),
                  void (this.coords.p_pointer = this.toFixed(
                  ...
                  if ('single' === this.options.type)
                    ...
                    this.labels.p_from_left + this.labels.p_from_fake >=
                      ...
                      : ((this.$cache.from[0].style.visibility = 'visible'),
                        ...
                        (this.$cache.single[0].style.visibility = 'hidden')),
                      f < this.labels.p_min + 1
                        ? (this.$cache.min[0].style.visibility = 'hidden')
                        : (this.$cache.min[0].style.visibility = 'visible'),
                      i > 100 - this.labels.p_max - 1
                        ? (this.$cache.max[0].style.visibility = 'hidden')
                        : (this.$cache.max[0].style.visibility = 'visible');
                  }
              }
            ...
            calcWithStep: function (a) {
              ...
              return (
                b > 100 && (b = 100), 100 === a && (b = 100), this.toFixed(b)
              );
            },
            checkMinInterval: function (a, b, c) {
              ...
              return d.min_interval
                ? ((e = this.convertToValue(a)),
                  ...
                  'from' === c
                    ? f - e < d.min_interval && (e = f - d.min_interval)
                    : e - f < d.min_interval && (e = f + d.min_interval),
                  this.convertToPercent(e))
                : a;
            },
            checkMaxInterval: function (a, b, c) {
              ...
              return d.max_interval
                ? ((e = this.convertToValue(a)),
                  (f = this.convertToValue(b)),
                  'from' === c
                    ? f - e > d.max_interval && (e = f - d.max_interval)
                    : e - f > d.max_interval && (e = f + d.max_interval),
                  this.convertToPercent(e))
                : a;
            },
            ...
            validate: function () {
              ...
              ('number' != typeof a.from || isNaN(a.from)) && (a.from = a.min),
                ...
                'single' === a.type
                  ...
                  : ((a.from < a.min || a.from > a.max) && (a.from = a.min),
                    (a.to > a.max || a.to < a.min) && (a.to = a.max),
                ...
                (b.min !== a.min && (b.min = a.min),
                  ...
                  (b.from < b.min || b.from > b.max) && (b.from = a.from),
                  (b.to < b.min || b.to > b.max) && (b.to = a.to)),
            ...
            decorate: function (a, b) {
              ...
              return (
                ...
                (c += a),
                d.max_postfix &&
                (d.values.length && a === d.p_values[d.max]
                  ? ((c += d.max_postfix), d.postfix && (c += ' '))
                  : b === d.max &&
                  ((c += d.max_postfix), d.postfix && (c += ' '))),
                            ...
                            !0,
                            {
                              ...
                              success: function (d) {
                                var h,
                                  ...
                                  j,
                                  g = d === !0 || 'true' === d;
                                (f.settings.messages[c.name].remote =
                                  e.originalMessage),
                                  g
                                    ? ((j = f.formSubmitted),
                                      f.prepareElement(c),
    ...
    12: [
      function (a, b, c) {
        !(function (d) {
          ...
          function e(c) {
            if (
              !a(c.target).parents().hasClass('jq-selectbox') &&
              'OPTION' != c.target.nodeName &&
              ...
              g.onSelectClosed.call(d),
                e.length && e.val('').keyup(),
                f.hide().find('li.sel').addClass('selected'),
                d.removeClass('focused opened dropup dropdown');
            }
          }
          var b = 'styler',
            c = {
          ...
          (d.prototype = {
            init: function () {
              function g() {
                ...
                void 0 !== b.attr('id') &&
                  '' !== b.attr('id') &&
                  (a = ' id="' + b.attr('id') + c.idSuffix + '"'),
                  void 0 !== b.attr('title') &&
                  '' !== b.attr('title') &&
                  (d = ' title="' + b.attr('title') + '"'),
                  void 0 !== b.attr('class') &&
                  '' !== b.attr('class') &&
                  (e = ' ' + b.attr('class'));
                var g = b.data();
              ...
              if (b.is(':checkbox')) {
                var h = function () {
                  var c = new g(),
                    d = a(
                      ...
                      '"' +
                      c.title +
                      '><div class="jq-checkbox__div"></div></div>'
                    );
                  b
                    .css({
                      position: 'absolute',
                    ...
                    d.click(function (a) {
                      a.preventDefault(),
                        d.is('.disabled') ||
                        (b.is(':checked')
                          ? (b.prop('checked', !1), d.removeClass('checked'))
                          : (b.prop('checked', !0), d.addClass('checked')),
                          b.focus().change());
                    }),
                    b
                      .closest('label')
                      ...
                      .on('click.styler', function (b) {
                        a(b.target).is('a') ||
                          a(b.target).closest(d).length ||
                          (d.triggerHandler('click'), b.preventDefault());
                      }),
                    b
                ...
                var i = function () {
                  var d = new g(),
                    e = a(
                      ...
                      '"' +
                      d.title +
                      '><div class="jq-radio__div"></div></div>'
                    );
                  b
                    .css({
                      position: 'absolute',
                    ...
                    b
                      ...
                      .on('click.styler', function (b) {
                        a(b.target).is('a') ||
                          ...
                          (e.triggerHandler('click'), b.preventDefault());
                      }),
                    b
                      .on('change.styler', function () {
                  ...
                  a('<div class="jq-file__browse">' + f + '</div>').appendTo(h),
                    ...
                    b
                      .on('change.styler', function () {
                        ...
                        i.text(a.replace(/.+[\\\/]/, '')),
                          '' === a
                            ? (i.text(e), h.removeClass('changed'))
                            : h.addClass('changed');
                      })
                      .on('focus.styler', function () {
                        h.addClass('focused');
                ...
                var k = function () {
                  ...
                  var d,
                    ...
                    g = null,
                    h = null;
                  void 0 !== b.attr('min') && (d = b.attr('min')),
                    void 0 !== b.attr('max') && (e = b.attr('max')),
                    (f =
                      void 0 !== b.attr('step') && a.isNumeric(b.attr('step'))
                        ? Number(b.attr('step'))
                        : Number(1));
                  var i = function (c) {
                    var h,
                    ...
                    a.isNumeric(g) || ((g = 0), b.val('0')),
                      c.is('.minus')
                        ? ((h = parseInt(g, 10) - f),
                          f > 0 && (h = Math.ceil(h / f) * f))
                        : c.is('.plus') &&
                        ((h = parseInt(g, 10) + f),
                          f > 0 && (h = Math.floor(h / f) * f)),
                      a.isNumeric(d) && a.isNumeric(e)
                        ? h >= d && e >= h && b.val(h)
                        : a.isNumeric(d) && !a.isNumeric(e)
                          ? h >= d && b.val(h)
                          : !a.isNumeric(d) && a.isNumeric(e)
                ...
                k(),
                  b.on('refresh', function () {
                    b.off('.styler').closest('.jq-number').before(b).remove(),
                      k();
                  });
              } else if (b.is('select')) {
                var l = function () {
                  function h(b) {
                    b.off('mousewheel DOMMouseScroll').on(
                  ...
                  function k() {
                    for (var a = 0; a < i.length; a++) {
                      ...
                      b.prop('selected') && (e = 'selected sel'),
                        ...
                        void 0 !== b.attr('id') &&
                        '' !== b.attr('id') &&
                        (g = ' id="' + b.attr('id') + c.idSuffix + '"'),
                        void 0 !== b.attr('title') &&
                        '' !== i.attr('title') &&
                        (h = ' title="' + b.attr('title') + '"'),
                        void 0 !== b.attr('class') &&
                        ((l = ' ' + b.attr('class')),
                  ...
                  function l() {
                    ...
                    J.length < 1 && z.first().addClass('selected sel'),
                      ...
                      z.data('li-height', z.outerHeight());
                    var K = x.css('top');
                    if (
                      ('auto' == x.css('left') && x.css({ left: 0 }),
                        ...
                        x.hide(),
                        J.length &&
                        (i.first().text() != w.text() && t.addClass('changed'),
                    ...
                    u.click(function () {
                      if (
                        (a('div.jq-selectbox').filter('.opened').length &&
                          c.onSelectClosed.call(
                        ...
                        var n = function () {
                          ...
                          var a = function () {
                            y.css(
                              'max-height',
                              Math.floor((j - 20 - H) / f) * f
                            );
                          };
                          a(),
                            y.css('max-height', m),
                            'none' != I && y.css('max-height', I),
                            j < x.outerHeight() + 20 && a();
                        },
                          o = function () {
                            ...
                            var a = function () {
                              y.css(
                                'max-height',
                                Math.floor((g - e.scrollTop() - 20 - H) / f) * f
                              );
                            };
                            a(),
                              y.css('max-height', m),
                              'none' != I && y.css('max-height', I),
                              g - e.scrollTop() - 20 < x.outerHeight() + 20 &&
                              a();
                          };
                        s === !0 || 1 === s
                          ? j > l + H + 20
                            ...
                            : (o(),
                              t.removeClass('dropdown').addClass('dropup'))
                          : (s === !1 || 0 === s) &&
                          j > l + H + 20 &&
                          (n(), t.removeClass('dropup').addClass('dropdown')),
                          t.offset().left + x.outerWidth() > e.width() &&
                          x.css({ left: 'auto', right: 0 }),
                          a('div.jqselect')
                            .css({ zIndex: r - 1 })
                            .removeClass('opened'),
                          t.css({ zIndex: r }),
                          x.is(':hidden')
                            ? (a('div.jq-selectbox__dropdown:visible').hide(),
                              x.show(),
                              t.addClass('opened focused'),
                              c.onSelectOpened.call(t))
                            : (x.hide(),
                              t.removeClass('opened dropup dropdown'),
                              a('div.jq-selectbox').filter('.opened').length &&
                              c.onSelectClosed.call(t)),
                          A.length &&
                          (A.val('').keyup(),
                            B.hide(),
                            A.keyup(function () {
                          ...
                          ('' === b.val()
                            ? y.scrollTop(0)
                            : ((y.innerHeight() / f) % 2 !== 0 && (f /= 2),
                              y.scrollTop(
                                y.scrollTop() +
                                z.filter('.selected').position().top -
                                y.innerHeight() / 2 +
                                f
                              ))),
                          h(y);
                    ...
                    z
                      ...
                      .click(function () {
                        ...
                        if (!d.is('.selected')) {
                          ...
                          (f -= d.prevAll('.optgroup').length),
                            ...
                            v.text(e),
                            t.data('jqfs-class') &&
                            t.removeClass(t.data('jqfs-class')),
                      ...
                      b
                        .on('change.styler', function () {
                          v
                            .text(i.filter(':selected').text())
                            .removeClass('placeholder'),
                            z
                              .removeClass('selected sel')
                              .not('.optgroup')
                              .eq(b[0].selectedIndex)
                              .addClass('selected sel'),
                            i.first().text() != z.filter('.selected').text()
                              ? t.addClass('changed')
                      ...
                      e.registered ||
                      (a(document).on('click', e), (e.registered = !0));
                  }
                  function m() {
                    var c = new g(),
                      d = a(
                        '<div' +
                        c.id +
                        ' class="jq-select-multiple jqselect' +
                        c.classes +
                        '"' +
                        c.title +
                        ' style="display: inline-block; position: relative"></div>'
                      );
                    b.css({ margin: 0, padding: 0 }).after(d),
                      k(),
                      d.append('<ul>' + j + '</ul>');
                    var e = a('ul', d).css({
                      position: 'relative',
                    ...
                    void 0 !== l && l > 0
                      ...
                      (e.css('overflowY', 'scroll'),
                        ...
                        e.scrollTop(
                          e.scrollTop() + f.filter('.selected').position().top
                        )),
                      b
                        .prependTo(d)
                        .css({
                      ...
                      b.is(':disabled')
                        ? (d.addClass('disabled'),
                          i.each(function () {
                            a(this).is(':selected') &&
                              f.eq(a(this).index()).addClass('selected');
                          }))
                        : (f
                          .filter(':not(.disabled):not(.optgroup)')
                          .click(function (c) {
                            ...
                            if (
                              (c.ctrlKey ||
                                ...
                                c.metaKey ||
                                c.shiftKey ||
                                d.siblings().removeClass('selected first'),
                                (c.ctrlKey || c.metaKey) &&
                                (d.is('.selected')
                                  ? d.removeClass('selected first')
                                  : d.addClass('selected first'),
                            ...
                            i.prop('selected', !1),
                              f.filter('.selected').each(function () {
                                var b = a(this),
                                  c = b.index();
                                b.is('.option') &&
                                  (c -= b.prevAll('.optgroup').length),
                                  i.eq(c).prop('selected', !0);
                              }),
                              b.change();
                          }),
                          i.each(function (b) {
                          ...
                          b.on('keydown.styler', function (a) {
                            (38 == a.which ||
                              ...
                              e.scrollTop(
                                e.scrollTop() +
                                f.filter('.selected').position().top -
                                n
                              ),
                              (40 == a.which ||
                                39 == a.which ||
                              ...
                              e.scrollTop(
                                e.scrollTop() +
                                f.filter('.selected:last').position()
                                  .top -
                                e.innerHeight() +
                                2 * n
                              );
              ...
              if ('string' == typeof c && '_' !== c[0] && 'init' !== c) {
                ...
                return (
                  this.each(function () {
                    ...
                    g instanceof d &&
                      'function' == typeof g[c] &&
                      (f = g[c].apply(g, Array.prototype.slice.call(e, 1)));
                  }),
                  void 0 !== f ? f : this
                );
              }
        ...
        !(function (a, c) {
          ...
          function Va(a, b, c) {
            ...
            c.queue ||
              ...
              ((c.overflow = [o.overflow, o.overflowX, o.overflowY]),
                (j = n.css(a, 'display')),
                (k =
                  'none' === j ? L.get(a, 'olddisplay') || ta(a.nodeName) : j),
                'inline' === k &&
                'none' === n.css(a, 'float') &&
              ...
              return (
                ...
                ia(function (f, g, h, i) {
                  var j,
                    ...
                    r = c ? (e || (f ? a : o || d) ? [] : g) : q;
                  if ((c && c(q, r, h, i), d))
                    for (j = va(r, n), d(j, [], h, i), k = j.length; k--;)
                      (l = j[k]) && (r[n[k]] = !(q[n[k]] = l));
                  if (f) {
                    if (e || a) {
                      if (e) {
          ...
          n.extend({
            ...
            (n.cssHooks.marginRight = ya(
              ...
              function (a, b) {
                return b
                  ? n.swap(a, { display: 'inline-block' }, xa, [
                    a,
                    'marginRight',
                  ])
                  : void 0;
