...
?>
		...
		method="get"
		 class="catalog-page__filter catalog__filter form" 
		 data-block='1'>
						...
						switch ($arItem["DISPLAY_TYPE"])
						{
							...
							default://CHECKBOXES
								...
								onclick="smartFilter.click(this)" 
									...
									<label for="<? echo $ar["CONTROL_ID"] ?>" class="checkbox__label form__label"><?=$ar["VALUE"];?></label>
...
?>
	...
	foreach($arResult["ITEMS"] as $key=>$arItem)
	{
		...
		<?endif;
			...
			<div class="clb"></div>
			<!-- <button id="set_filter" type="submit" class="btn">Показать товары</button> -->
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						<input class="bx_filter_search_button btn" type="submit" id="set_filter" name="set_filter" value="Показать товары"  />
